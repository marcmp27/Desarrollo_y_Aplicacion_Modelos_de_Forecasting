...
Por problemáticas con ciertos paquetes y su ejecución dentro de funciones, se ha tenido que realizar el código sin pasar por función para cada activo. Por lo tanto, el código que viene a continuación es el mismo código, para los 9 activos y para las tres temporalidades 27 repeticiones), modificando en cada caso las bases de datos utilizada. 
...
#arima garch siempre será rojo
#tbats siempre será azul
#Holt siempre será verde
```
